...
public class CNeurode : Neurode
{
 ...
 public override void RunForward(Neurode[][] network)
 {
     ...
     if (type == 9)// [0][o] [0][o] | [1][o] [1][o]      |        [2][o] [2][o] | [3][o] [3][o]       &&      [>]
     {
     ...
     if (type == 10)// [0][o] [0][o] | [1][o] [1][o]      |        [2][o] [2][o] | [3][o] [3][o]       &&      [>>]
     {
         float activationValueOuter = 0;
     ...
     if (type == 11)// [0][o] [0][o] | [1][o] [1][o]      |        [2][o] [2][o] | [3][o] [3][o]     &&      [...]
     {
         float activationValueOuter = 0;
       ...
       if (type == 1)
       {
           ...
           if (activationValue != 0)// [>>] Til Next Activation [>>]
               delta = activationValue
       }
       ...
       if (type == 2)
       {
           ...
           delta = Neurode.GetActivationValue(activationValue, type);//[...] Keep GateValue/Activation value [...]
